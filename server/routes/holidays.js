...
// ✅ Admin only routes — if you have middleware, apply it here
// e.g. const { isAdmin } = require("../middleware/auth");
...
// 🟡 Seed weekly offs for a specific year
router.post("/seed-weekly-offs", seedWeeklyOffs);
